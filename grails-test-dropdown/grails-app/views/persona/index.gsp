		...
		<div id="list-persona" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="appelidoPaterno" title="${message(code: 'persona.appelidoPaterno.label', default: 'Appelido Paterno')}" />
					
						<g:sortableColumn property="appelidoMaterno" title="${message(code: 'persona.appelidoMaterno.label', default: 'Appelido Materno')}" />
				...
				<g:each in="${personaInstanceList}" status="i" var="personaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personaInstance, field: "appelidoPaterno")}</td>
					
						<td>${fieldValue(bean: personaInstance, field: "appelidoMaterno")}</td>
