	...
	<body>
		...
		<div id="show-persona" class="content scaffold-show" role="main">
			...
			<ol class="property-list persona">
				...
				<g:if test="${personaInstance?.appelidoPaterno}">
				<li class="fieldcontain">
					<span id="appelidoPaterno-label" class="property-label"><g:message code="persona.appelidoPaterno.label" default="Appelido Paterno" /></span>
					
						<span class="property-value" aria-labelledby="appelidoPaterno-label"><g:fieldValue bean="${personaInstance}" field="appelidoPaterno"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${personaInstance?.appelidoMaterno}">
				<li class="fieldcontain">
					<span id="appelidoMaterno-label" class="property-label"><g:message code="persona.appelidoMaterno.label" default="Appelido Materno" /></span>
					
						<span class="property-value" aria-labelledby="appelidoMaterno-label"><g:fieldValue bean="${personaInstance}" field="appelidoMaterno"/></span>
